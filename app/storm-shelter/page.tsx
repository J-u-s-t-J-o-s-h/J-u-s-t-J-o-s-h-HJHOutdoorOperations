...
import { stormShelterFaqs } from '@/lib/faqs/storm-shelter'

const faqs = stormShelterFaqs
        ...
        <section className="relative flex min-h-[min(100dvh,56rem)] items-end overflow-hidden pb-16 sm:min-h-[60vh]">
          ...
          <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pt-[calc(9.75rem+env(safe-area-inset-top,0px))] sm:px-6 lg:px-8">
            ...
            <p className="text-shadow-strong text-warm-concrete text-lg max-w-2xl leading-relaxed mb-8">
              Oklahoma gets hit hard by tornadoes every season. HJH Outdoor Operations installs residential underground shelters and outdoor walk-in saferooms for homeowners near Oklahoma City, Blanchard, Duncan, Lawton, and communities statewide — done right, start to finish.
            </p>
